// report 70027 "Create Document No Req"
// {
//     Caption = 'Create Document No Req';
...
//                            InitItemTrkgForTempWkshLineNwmm(
...
//     [Scope('OnPrem')]
//     procedure SetAssignID()
//     begin
//         AssignedID := UserId;
//     end;

//     [Scope('OnPrem')]
//     procedure SetAssignUserID(UserIDP: Text)
//     begin

//         AssignedID := UserId;
//         if UserIDP <> '' then begin
//             AssignedID := Format(UserIDP);
//         end;
//     end;

//     procedure InitItemTrkgForTempWkshLineNwmm(WhseDocType: Option; WhseDocNo: Code[20]; WhseDocLineNo: Integer; SourceType: Integer; SourceSubtype: Integer; SourceNo: Code[20]; SourceLineNo: Integer; SourceSublineNo: Integer)
//     var
//         TempWhseWkshLine: Record "Whse. Worksheet Line";
//         ItemTracking: Codeunit "Item Tracking Management";
//     begin
...
//         ItemTracking.InitTrackingSpecification(TempWhseWkshLine);
//     end;
