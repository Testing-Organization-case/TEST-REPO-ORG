report 70028 "Barcode Printing For WHR"
{
    // 
    // //Refrence by NWV
    DefaultLayout = RDLC;
    RDLCLayout = '7.Layouts/BarcodePrintingForWHR.rdl';

    Caption = 'Barcode Printing For WHR';
        ...
        dataitem("Warehouse Receipt Header"; "Warehouse Receipt Header")
        {
            dataitem("Warehouse Receipt Line"; "Warehouse Receipt Line")
            {
                ...
                begin
                    ...
                    gRec_WHReceiptLIne := "Warehouse Receipt Line";
                    RecordNo := 1;
                end;
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                begin
                    ...
                    if gMainData.Code_4 <> '' then BarcodeLines1 := EncodedBarcode128(gMainData.Code_4); //ModifiedBy NWMM(CCW) 15Mar2022
                    if gMainData.Code_5 <> '' then BarcodeLines2 := EncodedBarcode128(gMainData.Code_5); //ModifiedBy NWMM(CCW) 15Mar2022
                    if gMainData.Code_6 <> '' then BarcodeLines3 := EncodedBarcode128(gMainData.Code_6); //ModifiedBy NWMM(CCW) 15Mar2022
    ...
    var
        ...
        gBarcode: array[3] of Record "Upgrade Blob Storage";       //Replaced Tempblob 
        ...
        BarcodeNumber3: Text;
        CurrencyCodeG: Text;
        gRec_WHReceiptLIne: Record "Warehouse Receipt Line";
    ...
    begin
        ...
        if RecordNo <= gPrintQty then begin
            ...
            gRec_Barcodes.Reset;
            gRec_Barcodes.SetRange("Item No.", gRec_WHReceiptLIne."Item No.");
            // gRec_Barcodes.SetRange("Variant Code", gRec_WHReceiptLIne."Variant Code"); //Updated
    ...
    begin
        ...
        // Main Sub
        gRec_Barcodes.Reset;
        gRec_Barcodes.SetRange("Item No.", "Warehouse Receipt Line"."Item No.");
        // gRec_Barcodes.SetRange("Variant Code", "Warehouse Receipt Line"."Variant Code"); //Updated
        gRec_Barcodes.SetRange("Barcode Active", true);
        if gRec_Barcodes.FindSet then
            repeat
                ItemUOM.Reset;
                ItemUOM.SetRange("Item No.", "Warehouse Receipt Line"."Item No.");
        ...
        ItemUOM.Reset;
        ItemUOM.SetRange("Item No.", "Warehouse Receipt Line"."Item No.");
        ItemUOM.SetRange(Code, "Warehouse Receipt Line"."Unit of Measure Code");
